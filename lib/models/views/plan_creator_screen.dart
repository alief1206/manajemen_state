...
import 'package:manajemen_state/provider/plan_provider.dart'; // PlanProvider import
import 'package:manajemen_state/models/data_layer.dart'; // Plan model import
...
class _PlanCreatorScreenState extends State<PlanCreatorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Master Plans Alief')),
      body: Column(
        children: [
          _buildListCreator(),
